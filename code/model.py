...
# Test code to check image loading and image array shape
# img_path = '../Data/Najdi/cropped/najdi_cropped_1.jpg'
...
for dataset in data_dir_list:
	...
	names.append(dataset) # Save the name of the dataset
